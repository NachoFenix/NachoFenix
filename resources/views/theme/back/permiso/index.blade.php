        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header bg-info">
                    ...
                    <a href="{{route('permiso.crear')}}" class="btn btn-outline-light btn-sm float-rigth d-inline">Crear permisos</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route("permiso.eliminar",$permiso->id)}}" method="post" class="form-eliminar d-inline">
                                            @csrf @method('delete')
