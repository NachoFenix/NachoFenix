        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header bg-info">
                    ...
                    <a href="{{route('rol.crear')}}" class="btn btn-outline-light btn-sm float-rigth d-inline">Crear roles</a>
                </div>
                <div class="card-body">
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$rol->slug}}</td>
                                    <td>
                                        <a href="{{route("rol.editar",$rol->id)}}" data-toggle="tooltip" title="Editar este registro"><i class="fas fa-edit"></i></a>
                                        <form action="{{route("rol.eliminar",$rol->id)}}" method="post" class="form-eliminar d-inline">
                                            @csrf @method('delete')
